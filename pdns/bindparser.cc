...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_AWORD = 3,                      /* AWORD  */
  YYSYMBOL_QUOTEDWORD = 4,                 /* QUOTEDWORD  */
  YYSYMBOL_OBRACE = 5,                     /* OBRACE  */
  YYSYMBOL_EBRACE = 6,                     /* EBRACE  */
  YYSYMBOL_SEMICOLON = 7,                  /* SEMICOLON  */
  YYSYMBOL_ZONETOK = 8,                    /* ZONETOK  */
  YYSYMBOL_FILETOK = 9,                    /* FILETOK  */
  YYSYMBOL_OPTIONSTOK = 10,                /* OPTIONSTOK  */
  YYSYMBOL_DIRECTORYTOK = 11,              /* DIRECTORYTOK  */
  YYSYMBOL_ACLTOK = 12,                    /* ACLTOK  */
  YYSYMBOL_LOGGINGTOK = 13,                /* LOGGINGTOK  */
  YYSYMBOL_CLASSTOK = 14,                  /* CLASSTOK  */
  YYSYMBOL_TYPETOK = 15,                   /* TYPETOK  */
  YYSYMBOL_PRIMARYTOK = 16,                /* PRIMARYTOK  */
  YYSYMBOL_ALSONOTIFYTOK = 17,             /* ALSONOTIFYTOK  */
  YYSYMBOL_YYACCEPT = 18,                  /* $accept  */
  YYSYMBOL_root_commands = 19,             /* root_commands  */
  YYSYMBOL_root_command = 20,              /* root_command  */
  YYSYMBOL_commands = 21,                  /* commands  */
  YYSYMBOL_command = 22,                   /* command  */
  YYSYMBOL_global_zone_command = 23,       /* global_zone_command  */
  YYSYMBOL_global_options_command = 24,    /* global_options_command  */
  YYSYMBOL_acl_command = 25,               /* acl_command  */
  YYSYMBOL_acl_block = 26,                 /* acl_block  */
  YYSYMBOL_acls = 27,                      /* acls  */
  YYSYMBOL_acl = 28,                       /* acl  */
  YYSYMBOL_options_commands = 29,          /* options_commands  */
  YYSYMBOL_options_command = 30,           /* options_command  */
  YYSYMBOL_options_directory_command = 31, /* options_directory_command  */
  YYSYMBOL_also_notify_command = 32,       /* also_notify_command  */
  YYSYMBOL_also_notify_list = 33,          /* also_notify_list  */
  YYSYMBOL_also_notify = 34,               /* also_notify  */
  YYSYMBOL_terms = 35,                     /* terms  */
  YYSYMBOL_term = 36,                      /* term  */
  YYSYMBOL_block = 37,                     /* block  */
  YYSYMBOL_zone_block = 38,                /* zone_block  */
  YYSYMBOL_zone_commands = 39,             /* zone_commands  */
  YYSYMBOL_zone_command = 40,              /* zone_command  */
  YYSYMBOL_zone_primaries_command = 41,    /* zone_primaries_command  */
  YYSYMBOL_zone_also_notify_command = 42,  /* zone_also_notify_command  */
  YYSYMBOL_zone_also_notify_list = 43,     /* zone_also_notify_list  */
  YYSYMBOL_zone_also_notify = 44,          /* zone_also_notify  */
  YYSYMBOL_primaries = 45,                 /* primaries  */
  YYSYMBOL_primary = 46,                   /* primary  */
  YYSYMBOL_zone_file_command = 47,         /* zone_file_command  */
  YYSYMBOL_zone_type_command = 48,         /* zone_type_command  */
  YYSYMBOL_quotedname = 49,                /* quotedname  */
  YYSYMBOL_filename = 50                   /* filename  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "AWORD", "QUOTEDWORD",
  "OBRACE", "EBRACE", "SEMICOLON", "ZONETOK", "FILETOK", "OPTIONSTOK",
  "DIRECTORYTOK", "ACLTOK", "LOGGINGTOK", "CLASSTOK", "TYPETOK",
  "PRIMARYTOK", "ALSONOTIFYTOK", "$accept", "root_commands",
  "root_command", "commands", "command", "global_zone_command",
  "global_options_command", "acl_command", "acl_block", "acls", "acl",
  "options_commands", "options_command", "options_directory_command",
  "also_notify_command", "also_notify_list", "also_notify", "terms",
  "term", "block", "zone_block", "zone_commands", "zone_command",
  "zone_primaries_command", "zone_also_notify_command",
  "zone_also_notify_list", "zone_also_notify", "primaries", "primary",
  "zone_file_command", "zone_type_command", "quotedname", "filename", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 11: /* global_zone_command: ZONETOK quotedname zone_block  */
...
#line 1362 "bindparser.cc"
    break;

  case 12: /* global_zone_command: ZONETOK quotedname AWORD zone_block  */
#line 142 "bindparser.yy"
        {
...
#line 1475 "bindparser.cc"
    break;


#line 1479 "bindparser.cc"
